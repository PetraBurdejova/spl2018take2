...
model_auto.theft2<-lm(auto.theft~male.youth+less.than.high.school+low.income, data=r)
...
model_break.and.enter2<-lm(break.and.enter~male.youth+less.than.high.school+low.income+immigrants, data=r)
...
###variable selection - aic backwards selection
step(model_robbery)
model_robbery2<-lm(robbery~male.youth+less.than.high.school+low.income+immigrants, data=r)
...
model_theft.over2<-lm(theft.over~male.youth+less.than.high.school+low.income+immigrants, data=r)
...
r_drug.arrests <- r[-c(77,76,73,93,75),]
...
model_drug.arrests2<-lm(drug.arrests~male.youth+less.than.high.school+low.income+immigrants, data=r)
...
model_total.crime2<-lm(total.crime~male.youth+less.than.high.school+low.income+immigrants, data=r)
